<template>
  <div class="s-table" :class="{'s-table_moving': dragState.dragging}">
    <el-table :data="data"
...
.s-table {
  padding:100px;
  .el-table .darg_start {   background-color: #f3f3f3;   }
  .el-table th {
    padding: 0;
    .virtual{
      position: fixed;
    ...
    &.darg_active_left {
      .virtual {
        border-left: 2px dotted #666;        z-index: 99;
      }
    }
    &.darg_active_right {
      .virtual {
        border-right: 2px dotted #666;        z-index: 99;
      }
    }
  }
  .thead-cell {
